            ...
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  ...
                  <Link href="/gamma" className="border-[#0C797D] text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium uppercase tracking-widest">
                    Gamma
                  </Link>
                </div>
              </div>
