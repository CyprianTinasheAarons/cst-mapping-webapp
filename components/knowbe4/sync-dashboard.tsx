...
import {
  fetchKnowbe4Customers,
  updateKnowbe4CustomerSync,
  updateKnowbe4Item,
  fetchKnowbe4Items,
} from "../../slices/knowbe4/knowbe4Slice";
import {
  fetchHaloClients,
  fetchHaloItems,
  fetchHaloContracts,
...
export function Knowbe4SyncDashboard() {
  ...
  const {
    customers: knowbe4Customers,
    status: knowbe4Status,
    items: knowbe4Items,
  } = useAppSelector((state) => state.knowbe4);
  ...
  useEffect(() => {
    if (knowbe4Status === "idle") {
      dispatch(fetchKnowbe4Customers());
      dispatch(fetchKnowbe4Items());
    }
  }, [knowbe4Status]);
  ...
  const filteredCustomers = knowbe4Customers
    .filter(
      (customer) =>
        customer.knowbe4_name
          .toLowerCase()
          .includes(customerSearch.toLowerCase()) ||
        customer.customer_knowbe4_id.includes(customerSearch)
    )
    .sort((a, b) => a.knowbe4_name.localeCompare(b.knowbe4_name));
  ...
  const handleUpdateSubscriptionDisabled = async (
    ...
    try {
      ...
      await dispatch(fetchKnowbe4Customers());
      await dispatch(fetchKnowbe4Items());
  ...
  const safeKnowbe4Items = Array.isArray(knowbe4Items) ? knowbe4Items : [];
              ...
              <div className="w-full max-w-[900px] mx-auto">
                <TabsContent value="customers" className="space-y-4">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead>Knowbe4 Customer</TableHead>
                    ...
                    <TableBody>
                      {paginatedCustomers.map((customer) => (
                        <TableRow key={customer.customer_knowbe4_id}>
                          <TableCell className="font-medium">
                            {customer.knowbe4_name}
                            <div className="text-sm text-muted-foreground">
                              {customer.customer_knowbe4_id}
                            </div>
                          </TableCell>
                          <TableCell className="font-medium">
                            {customer.synced ? (
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {knowbe4Status === "loading" ? (
                        ...
                        paginatedCustomers.map((customer) => (
                          <React.Fragment key={customer.customer_knowbe4_id}>
                            <TableRow>
                              <TableCell
                              ...
                              >
                                <div className="flex justify-between items-center w-full">
                                  ...
                                  <Badge variant="outline">
                                    {safeKnowbe4Items?.filter(
                                      (item) =>
                                        item.customer_knowbe4_id ===
                                        customer.customer_knowbe4_id
                                    ).length || 0}{" "}
                                    Subscriptions
                                  </Badge>
                            ...
                            {safeKnowbe4Items?.filter(
                              ...
                              safeKnowbe4Items
                                ...
                                .map((subscription) => (
                                  <TableRow
                                    key={`${customer.customer_knowbe4_id}-${subscription.id}`}
                                      ...
                                      <div className="flex justify-between items-center">
                                        <div>
                                          <div className="font-medium">
                                            {subscription.item_knowbe4_name}
                                          </div>
                                          <div className="text-sm text-muted-foreground">
                                            ID: {subscription.item_knowbe4_id}
                                          </div>
                                          <div className="text-sm text-muted-foreground">
